                            ...
                            <div class="row">
                                <div class="col-lg-2">
                                    <div class="details-image-vertical black-slide rounded">
                                        ...
                                        @if($product->images)
                                            @php
                                                $images1 = explode(',', $product->images);
                                            @endphp
                        ...
                        <div class="col-md-6">
                            <div class="cloth-details-size">
                                ...
                                <h3 class="price-detail">
                                    ...
                                    <span>{{round((($product->regular_price - $product->sale_price)/100) * $product->regular_price)}}
                                        % off</span></h3>
                                    @endif
                        ...
                        <div class="product-box">
                            ...
                            <div class="product-details">
                                ...
                                <div class="main-price">
                                    <a href="{{route('product.details',['slug'=>$rproduct->slug])}}" class="font-default">
                                        <h5>{{$rproduct->name}}</h5>
                                    </a>
                                    <div class="listing-content">
                                        <span class="font-light">Regular Fit</span>
                                        <p class="font-light">{{$rproduct->desc}}</p>
                                    </div>
                                    ...
                                    <button onclick="location.href = '{{route('cart.index')}}}';" class="btn listing-content">Add
                                        To Cart</button>
                                </div>
                            </div>
                        </div>
